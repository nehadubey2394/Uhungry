...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<SubIngModel> childtems;
    private String uri = "";

    public ExpandableListAdapter(Activity activity,ArrayList<Ingredients> parents) {
        ...
        if (parentArrayList.size()!=0){
            try {
                ...
                if (!ingredients.itemImg.equals("")){
                    Picasso.with(activity).load(ingredients.itemImg).placeholder(holder.ivGrocey.getDrawable()).resize(100,100).into(holder.ivGrocey);
                }
